...
If cammWebManager.CurrentUserLoginName <> "" Then 
	%><table border="0" cellpadding="0" cellspacing="0"><tr><td valign="top" align="center"><font size="1" face="Arial"><%= cammWebManager.Internationalization.StatusLineLoggedInAs %><br><a href="<%= Response.ApplyAppPathModifier("/sysdata/account_updateprofile.aspx") %>?ID=<%= cammWebManager.CurrentUserID(CompuMaster.camm.WebManager.WMSystem.SpecialUsers.User_Anonymous) %>" target="frame_main"><%= cammWebManager.CurrentUserInfo(CompuMaster.camm.WebManager.WMSystem.SpecialUsers.User_Anonymous).FullName & " (" & cammWebManager.CurrentUserLoginName & ")" %></a></font></td><td>&nbsp; &nbsp; </td><td valign="top" align="left"><img src="/system/images/space.gif" border="0" width="39" height="6"><br><a href="/sysdata/logon.aspx?Action=Logout" target="frame_main"><img src="/sysdata/images/sub/but_logout.gif" border="0" width="39" height="14"></a></td><tr></table><% 
Else
