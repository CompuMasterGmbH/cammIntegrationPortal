...
<TABLE cellSpacing="0" cellPadding="3" width="100%" border="0">
	...
	<TR>
		<TD>
			<asp:DataGrid id="DataGridHtmlTemplate" runat="server" CellPadding="3" EnableViewState=False 
				CellSpacing="0" CssClass="grid" AutoGenerateColumns="False" width="100%">
	...
	<TR>
		<TD>
			<TABLE cellSpacing="0" cellPadding="3" width="100%" border="0">
				<TR>
					<TD width="30%">
						<asp:Label ID="LabelNewTemplateName" Runat="server"></asp:Label>:&nbsp;<asp:TextBox id="TextBoxNewTemplateName" Runat="server" MaxLength="100"></asp:TextBox></TD>
					<TD width="30%">
					<TD width="40%">
						<asp:Button id="ButtonAddTemplate" Width="110" Runat="server"></asp:Button></TD>
					<TD>
					</TD>
				</TR>
			</TABLE>
