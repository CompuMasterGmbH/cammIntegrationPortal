...
<SCRIPT type="text/javascript" language=javascript>
        ...
        var MenuStateCookieName = "<% If cammWebManager.IsLoggedOn Then Response.Write ("MenuStateSecured" & LanguageID) Else Response.Write ("MenuStateAnonymous" & LanguageID) %>";
        getState(menuId);
