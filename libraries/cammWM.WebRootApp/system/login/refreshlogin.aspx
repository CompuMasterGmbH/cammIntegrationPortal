...
<%
	...
	If cammWebManager.IsLoggedOn AndAlso Request.QueryString("RoundTrip") <> "completed" Then
		...
		End If
		If cammWebManager.IsLoggedOnImpersonationUser = False Then
			TestSessionTermination = cammWebManager.System_IsSessionTerminated (cammWebManager.CurrentUserLoginName)
		End If
	End If
%>
