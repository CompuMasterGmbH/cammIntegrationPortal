'Copyright 2001,2002,2003,2008,2009,2015,2016 CompuMaster GmbH, http://www.compumaster.de and/or its affiliates. All rights reserved.
'---------------------------------------------------------------
...
Module Main
    ...
    Sub Main()
        Try
            Create_InternationlizationsScriptFile("out\web-scripts-aspx\sysdata\custom_internationalization.vb", "ScriptEngineValue_VB_NET_DLL", "app_data\custom_internationalization.vb.xsl", "source.xml")
            Create_InternationlizationsScriptFile("out\web-scripts-asp\system\internationalization.asp", "ScriptEngineValue_ASP", "app_data\internationlization.asp.xsl")
            Create_InternationlizationsScriptFile("out\cwm-lib\internationalization.vb", "ScriptEngineValue_VB_NET_DLL", "app_data\internationlization.vb.xsl")
            Create_InternationlizationsScriptFile("out\db-sqls\camm_WebManager_markets.sql", "ScriptEngineValue_VB_NET_DLL", "app_data\camm_WebManager_markets.sql.xsl")
            Create_InternationlizationsScriptFile("out\db-sqls\camm_WebManager_markets.azure.sql", "ScriptEngineValue_VB_NET_DLL", "app_data\camm_WebManager_markets.azure.sql.xsl")
        Catch ex As Exception
            If System.Environment.GetCommandLineArgs.Length = 2 AndAlso (System.Environment.GetCommandLineArgs(1).ToLowerInvariant() = "/batch" OrElse System.Environment.GetCommandLineArgs(1).ToLowerInvariant() = "-batch") Then
