...
Namespace CompuMaster.camm.SmartWebEditor
    ...
    Public Class UploadFormParameters
        ...
        ''' <summary>
        ''' Virtual path where uploaded files should be stored
        ''' </summary>
        Public UploadPath As String

        ''' <summary>
        ''' Paths to read only directories, where we should read images from
        ''' </summary>
        ...
        Public SecurityObject As String
        ''' <summary>
        ''' Maximum size  of a file (in bytes)
        ''' </summary>
        Public MaxUploadSize As Integer


        ''' <summary>
        ''' The name of a javascript callback function, to which we pass the path to an uploaded file
        ''' </summary>
        Public JavaScriptCallBackFunctionName As String
