<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.NewUsersOverview" %>
...
<HTML>
	<HEAD>
		<title>new_users_overview</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
			<div align="center">
				<uc1:control_number_new_users id="NumberNewUsersControl" runat="server"></uc1:control_number_new_users></div>
