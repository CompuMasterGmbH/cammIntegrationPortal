<%
dim Logon_AskForForcingLogon
dim UserManagementSalutationFormulaUnformalUndefinedGender
dim UserManagementSalutationFormulaInMailsUndefinedGender
dim UserManagementSalutationFormulaUndefinedGender
dim UserManagementSalutationFormulaInMailsGroup
dim UserManagementSalutationFormulaUnformalWithFirstNameUndefinedGender
dim UserManagementSalutationFormulaUnformalGroup
dim UserManagementSalutationFormulaUnformalWithFirstNameGroup
dim UserManagementSalutationFormulaGroup
dim UserManagementSalutationFormulaInMailsFeminin
dim UserManagementSalutationFormulaFeminin
dim UserManagementSalutationFormulaInMailsMasculin
dim UserManagementSalutationFormulaMasculin
dim UserManagementSalutationFormulaUnformalFeminin
dim UserManagementSalutationFormulaUnformalMasculin
dim UserManagementSalutationFormulaUnformalWithFirstNameFeminin
dim UserManagementSalutationFormulaUnformalWithFirstNameMasculin
dim ErrorRequiredField
dim SystemButtonYes
dim SystemButtonNo
dim SystemButtonOkay
dim SystemButtonCancel
dim ErrorUserOrPasswordWrong
dim ErrorServerConfigurationError
dim ErrorNoAuthorization
dim ErrorAlreadyLoggedOn
dim ErrorLoggedOutBecauseLoggedOnAtAnotherMachine
dim InfoUserLoggedOutSuccessfully
dim ErrorLogonFailedTooOften
dim ErrorEmptyPassword
dim ErrorUnknown
dim ErrorEmptyField
dim ErrorWrongNetwork
dim ErrorUserAlreadyExists
dim ErrorLoginCreatedSuccessfully
dim ErrorSendPWWrongLoginOrEmailAddress
dim ErrorCookiesMustNotBeDisabled
dim ErrorTimoutOrLoginFromAnotherStation
dim ErrorApplicationConfigurationIsEmpty
dim UserManagementEMailColumnTitleLogin
dim UserManagementEMailColumnTitleCompany
dim UserManagementEMailColumnTitleName
dim UserManagementEMailColumnTitleEMailAddress
dim UserManagementEMailColumnTitleStreet
dim UserManagementEMailColumnTitleZIPCode
dim UserManagementEMailColumnTitleLocation
dim UserManagementEMailColumnTitleState
dim UserManagementEMailColumnTitleCountry
dim UserManagementEMailColumnTitle1stLanguage
dim UserManagementEMailColumnTitle2ndLanguage
dim UserManagementEMailColumnTitle3rdLanguage
dim UserManagementEMailColumnTitleComesFrom
dim UserManagementEMailColumnTitleMotivation
dim UserManagementEMailColumnTitleCustomerNo
dim UserManagementEMailColumnTitleSupplierNo
dim UserManagementEMailColumnTitleComment
dim UserManagementEMailTextDearMr
dim UserManagementEMailTextDearMs
dim UserManagementEMailTextDearUndefinedGender
dim UserManagementSalutationUnformalMasculin
dim UserManagementSalutationUnformalFeminin
dim UserManagementSalutationUnformalUndefinedGender
dim UserManagementEMailTextRegards
dim UserManagementEMailTextSubject
dim UserManagementEMailTextSubject4AdminNewUser
dim UserManagementAddressesMr
dim UserManagementAddressesMs
dim UserManagementMasterServerAvailableInNearFuture
dim HighlightTextIntro
dim HighlightTextTechnicalSupport
dim HighlightTextExtro
dim WelcomeTextWelcomeMessage
dim WelcomeTextFeedbackToContact
dim WelcomeTextIntro
dim NavAreaNameYourProfile
dim NavAreaNameLogin
dim NavLinkNameUpdatePasswort
dim NavLinkNameUpdateProfile
dim NavLinkNameLogout
dim NavLinkNameLogin
dim NavLinkNamePasswordRecovery
dim NavLinkNameNewUser
dim NavPointUpdatedHint
dim NavPointTemporaryHiddenHint
dim Banner_Help
dim Banner_HeadTitle
dim Banner_BodyTitle
dim Banner_Feedback
dim StatusLineLoggedInAs
dim StatusLineUsername
dim StatusLinePassword
dim StatusLineSubmit
dim StatusLineContactUs
dim StatusLineLegalNote
dim StatusLineEditorial
dim StatusLineDataprotection
dim StatusLineCopyright_AllRightsReserved
dim META_CurrentContentLanguage
dim META_DescriptionContent
dim META_PageTopicContent
dim META_KeywordContent
dim SendPassword_Descr_FollowingError
dim SendPassword_Descr_LoginDenied
dim SendPassword_Descr_Title
dim SendPassword_Descr_LoginName
dim SendPassword_Descr_Email
dim SendPassword_Descr_Submit
dim SendPassword_Descr_RequiredFields
dim SendPassword_Descr_BackToLogin
dim SendPassword_Descr_PasswordSentTo
dim SendPassword_Descr_FurtherCommentWithContactAddress
dim AccessError_Descr_FollowingError
dim AccessError_Descr_BackToLogin
dim AccessError_Descr_LoginDenied
dim Logon_Connecting_InProgress
dim Logon_BodyTitle
dim Logon_HeadTitle
dim Logon_Connecting_LoginTimeout
dim Logon_Connecting_RecommendationOnTimeout
dim Logon_BodyPrompt2User
dim Logon_BodyFormUserName
dim Logon_BodyFormUserPassword
dim Logon_BodyFormSubmit
dim Logon_SSO_ADS_PageTitle
dim Logon_SSO_ADS_IdentifiedUserName
dim Logon_SSO_ADS_LabelTakeAnAction
dim Logon_SSO_ADS_RadioRegisterExisting
dim Logon_SSO_ADS_RadioRegisterNew
dim Logon_SSO_ADS_RadioDoNothing
dim Logon_SSO_ADS_ContactUs
dim Logon_SSO_ADS_ButtonNext
dim Logon_SSO_ADS_LabelRegisterExistingLoginName
dim Logon_SSO_ADS_LabelRegisterExistingPassword
dim Logon_SSO_ADS_LabelRegisterNewPassword2
dim Logon_SSO_ADS_LabelRegisterNewEMail
dim Logon_SSO_ADS_IdentifiedUserNameWithAdsUserInfo
dim Logon_BodyFormCreateNewAccount
dim Logon_BodyExplanation
dim CreateAccount_Descr_FollowingError
dim CreateAccount_Descr_LoginDenied
dim CreateAccount_Descr_Title
dim CreateAccount_Descr_LoginName
dim CreateAccount_Descr_Submit
dim CreateAccount_Descr_RequiredFields
dim CreateAccount_Descr_BackToLogin
dim CreateAccount_Descr_PageTitle
dim CreateAccount_Descr_UserLogin
dim CreateAccount_Descr_NewLoginName
dim CreateAccount_Descr_NewLoginPassword
dim CreateAccount_Descr_NewLoginPasswordConfirmation
dim CreateAccount_Descr_Address
dim CreateAccount_Descr_Company
dim CreateAccount_Descr_Addresses
dim CreateAccount_Descr_PleaseSelect
dim CreateAccount_Descr_AcademicTitle
dim CreateAccount_Descr_FirstName
dim CreateAccount_Descr_LastName
dim CreateAccount_Descr_NameAddition
dim CreateAccount_Descr_Email
dim CreateAccount_Descr_Street
dim CreateAccount_Descr_ZIPCode
dim CreateAccount_Descr_Location
...
dim UpdateProfile_Descr_MotivItemWebSiteVisitor
dim CreateAccount_Descr_MotivItemJournalist
dim CreateAccount_Descr_MotivItemOther
dim UpdateProfile_Descr_MotivItemJournalist
dim UpdateProfile_Descr_MotivItemOther
dim CreateAccount_Descr_WhereHeard
dim CreateAccount_Descr_WhereItemResellerDealer
dim CreateAccount_Descr_WhereItemFriend
dim UpdateProfile_Descr_WhereItemResellerDealer
dim UpdateProfile_Descr_WhereItemFriend
dim CreateAccount_Descr_WhereItemExhibition
dim CreateAccount_Descr_WhereItemFromUsOurselves
dim CreateAccount_Descr_WhereItemMagazines
dim UpdateProfile_Descr_WhereItemExhibition
dim UpdateProfile_Descr_WhereItemFromUsOurselves
dim UpdateProfile_Descr_WhereItemMagazines
dim CreateAccount_Descr_WhereItemSearchEnginge
dim CreateAccount_Descr_UserDetails
dim CreateAccount_Descr_WhereItemOther
dim UpdateProfile_Descr_WhereItemSearchEnginge
dim UpdateProfile_Descr_WhereItemOther
dim CreateAccount_Descr_Comments
dim ResetPW_Descr_PleaseSpecifyNewPW
dim CreateAccount_Descr_1stPreferredLanguage
dim CreateAccount_Descr_RequestAdditionalAuthorizations
dim CreateAccount_Descr_2ndPreferredLanguage
dim CreateAccount_Descr_3rdPreferredLanguage
dim CreateAccount_Descr_CustomerSupplierData
dim CreateAccount_Descr_MotivItemSupplier
dim CreateAccount_Descr_SupplierNo
dim CreateAccount_Descr_CustomerNo
dim UpdateProfile_Descr_MotivItemSupplier
dim CreateAccount_ErrorJS_InputValue
dim CreateAccount_ErrorJS_Length
dim UpdateProfile_ErrorJS_InputValue
dim UpdateProfile_ErrorJS_Length
dim UpdatePW_Descr_Title
dim UpdatePW_ErrMsg_ConfirmationFailed
dim UpdatePW_ErrMsg_InsertAllRequiredPWFields
dim UpdatePW_ErrMsg_Undefined
dim UpdatePW_ErrMsg_Success
dim UpdatePW_ErrMsg_WrongOldPW
dim UpdatePW_ErrMsg_InsertAllRequiredFields
dim UpdatePW_Descr_PleaseSpecifyCurrendAndOldPW
dim UpdatePW_Descr_CurrentPW
dim UpdatePW_Descr_NewPW
dim UpdatePW_Descr_NewPWConfirm
dim UpdatePW_Descr_Submit
dim UpdatePW_Descr_RequiredFields
dim UpdatePW_Error_PasswordComplexityPolicy
dim UserJustCreated_Descr_AccountCreated
dim UserJustCreated_Descr_LookAroundNow
dim UserJustCreated_Descr_PleaseNote
dim UserJustCreated_Descr_Title
dim UpdateProfile_Descr_Title
dim UpdateProfile_Descr_Mobile
dim UpdateProfile_Descr_Fax
dim UpdateProfile_Descr_Phone
dim UpdateProfile_Descr_PositionInCompany
dim UpdateProfile_ErrMsg_InsertAllRequiredFields
dim UpdateProfile_ErrMsg_MistypedPW
dim UpdateProfile_ErrMsg_Undefined
dim UpdateProfile_ErrMsg_Success
dim UpdateProfile_ErrMsg_LogonTooOften
dim UpdateProfile_ErrMsg_NotAllowed
dim UpdateProfile_ErrMsg_PWRequired
dim UpdateProfile_Descr_Address
dim UpdateProfile_Descr_Company
dim UpdateProfile_Descr_Addresses
dim UpdateProfile_Descr_PleaseSelect
dim UpdateProfile_Abbrev_Mister
dim UpdateProfile_Abbrev_Miss
dim UpdateProfile_Descr_AcademicTitle
dim UpdateProfile_Descr_FirstName
dim UpdateProfile_Descr_LastName
dim UpdateProfile_Descr_NameAddition
dim UpdateProfile_Descr_EMail
dim UpdateProfile_Descr_Street
dim UpdateProfile_Descr_ZIPCode
dim UpdateProfile_Descr_Location
dim UpdateProfile_Descr_State
dim UpdateProfile_Descr_Country
dim UpdateProfile_Descr_UserDetails
dim UpdateProfile_Descr_1stLanguage
dim UpdateProfile_Descr_2ndLanguage
dim UpdateProfile_Descr_3rdLanguage
dim UpdateProfile_Descr_Authentification
dim UpdateProfile_Descr_Password
dim UpdateProfile_Descr_Submit
dim UpdateProfile_Descr_RequiredFields
dim UpdateProfile_Descr_CustomerSupplierData
dim UpdateProfile_Descr_CustomerNo
dim UpdateProfile_Descr_SupplierNo
dim CreateAccount_MsgEMailWelcome
dim CreateAccount_MsgEMailWelcome_WithPassword
dim CreateAccount_MsgEMail4Admin
dim UserManagement_NewUser_TextWelcome
dim UserManagement_NewUser_HTMLWelcome
dim UserManagement_NewUser_MsgEMail4Admin
dim SendPassword_EMailMessage
dim SendPasswordResetLink_EMailMessage
dim UserManagement_ResetPWByAdmin_EMailMsg
dim UserManagement_NewUser_SubjectAuthCheckSuccessfull
dim UserManagement_NewUser_TextAuthCheckSuccessfull
dim UserManagementEMailTextDearMsWithAcademicTitle
dim UserManagementEMailTextDearMrWithAcademicTitle
dim UserManagementPleaseAssignMemberships
dim UserManagementResetPasswordBySecurityAdmin
dim UserManagementDonTForgetToChangePassword
dim HighlightTexteMedia
dim DoNotRedirectToLoginPathWithRefererDataIfNotLoggedIn
dim UserManagementAdjustMembershipsHere
...
Function GetLanguageIDOfBrowserSetting(SettingValue)
	...
	Select Case LCase(SettingValue)
		Case "af": Result = 12
		Case "af-af": Result = 12
		Case "ar": Result = 21
		Case "ar-ae": Result = 494
		Case "ar-ar": Result = 21
		Case "ar-bh": Result = 481
		Case "ar-dz": Result = 480
		Case "ar-eg": Result = 479
		Case "ar-iq": Result = 482
		Case "ar-jo": Result = 484
		Case "ar-kw": Result = 486
		Case "ar-lb": Result = 487
		Case "ar-ly": Result = 488
		Case "ar-ma": Result = 489
		Case "ar-om": Result = 490
		Case "ar-qa": Result = 485
		Case "ar-sa": Result = 491
		Case "ar-sy": Result = 492
		Case "ar-tn": Result = 493
		Case "ar-ye": Result = 483
		Case "as": Result = 28
		Case "as-as": Result = 28
		Case "az": Result = 36
		Case "az-az": Result = 36
		Case "be": Result = 47
		Case "be-be": Result = 47
		Case "bg": Result = 65
		Case "bg-bg": Result = 65
		Case "bn": Result = 49
		Case "bn-bn": Result = 49
		Case "ca": Result = 71
		Case "ca-ca": Result = 71
		Case "cs": Result = 75
		Case "cs-cs": Result = 75
		Case "da": Result = 104
		Case "da-da": Result = 104
		Case "de": Result = 2
		Case "de-at": Result = 512
		Case "de-ch": Result = 513
		Case "de-de": Result = 558
		Case "de-li": Result = 510
		Case "de-lu": Result = 511
		Case "el": Result = 164
		Case "el-el": Result = 164
		Case "en": Result = 1
		Case "en-au": Result = 514
		Case "en-bz": Result = 515
		Case "en-ca": Result = 519
		Case "en-en": Result = 1
		Case "en-gb": Result = 516
		Case "en-ie": Result = 517
		Case "en-jm": Result = 518
		Case "en-nz": Result = 521
		Case "en-ph": Result = 522
		Case "en-tt": Result = 524
		Case "en-us": Result = 478
		Case "en-za": Result = 523
		Case "en-zw": Result = 525
		Case "es": Result = 4
		Case "es-ar": Result = 530
		Case "es-bo": Result = 531
		Case "es-cl": Result = 532
		Case "es-co": Result = 540
		Case "es-cr": Result = 533
		Case "es-do": Result = 534
		Case "es-ec": Result = 535
		Case "es-es": Result = 560
		Case "es-gt": Result = 537
		Case "es-hn": Result = 538
		Case "es-mx": Result = 541
		Case "es-ni": Result = 542
		Case "es-pa": Result = 543
		Case "es-pe": Result = 545
		Case "es-pr": Result = 546
		Case "es-py": Result = 544
		Case "es-sv": Result = 536
		Case "es-us": Result = 549
		Case "es-uy": Result = 548
		Case "es-ve": Result = 550
		Case "et": Result = 127
		Case "et-et": Result = 127
		Case "eu": Result = 43
		Case "eu-eu": Result = 43
		Case "fa": Result = 555
		Case "fa-fa": Result = 555
		Case "fi": Result = 136
		Case "fi-fi": Result = 136
		Case "fo": Result = 554
		Case "fo-fo": Result = 554
		Case "fr": Result = 3
		Case "fr-be": Result = 500
		Case "fr-ca": Result = 501
		Case "fr-ch": Result = 504
		Case "fr-fr": Result = 559
		Case "fr-lu": Result = 502
		Case "fr-mc": Result = 503
		Case "gd": Result = 153
		Case "gd-gd": Result = 153
		Case "gl": Result = 556
		Case "gl-gl": Result = 556
		Case "gu": Result = 166
		Case "gu-gu": Result = 166
		Case "he": Result = 171
		Case "he-he": Result = 171
		Case "hi": Result = 175
		Case "hi-hi": Result = 175
		Case "hr": Result = 179
		Case "hr-hr": Result = 179
		Case "hu": Result = 180
		Case "hu-hu": Result = 180
		Case "hy": Result = 23
		Case "hy-hy": Result = 23
		Case "id": Result = 194
		Case "id-id": Result = 194
		Case "is": Result = 185
		Case "is-is": Result = 185
		Case "it": Result = 200
		Case "it-ch": Result = 505
		Case "it-it": Result = 200
		Case "ja": Result = 202
		Case "ja-ja": Result = 202
		Case "ka": Result = 551
		Case "ka-ka": Result = 551
		Case "kk": Result = 216
		Case "kk-kk": Result = 216
		Case "kn": Result = 210
		Case "kn-kn": Result = 210
		Case "ko": Result = 228
		Case "kok": Result = 225
		Case "ko-ko": Result = 228
		Case "kz": Result = 223
		Case "kz-kz": Result = 223
		Case "lt": Result = 246
		Case "lt-lt": Result = 246
		Case "lv": Result = 242
		Case "lv-lv": Result = 242
		Case "mk": Result = 277
		Case "mk-mk": Result = 277
		Case "ml": Result = 263
		Case "ml-ml": Result = 263
		Case "mn": Result = 286
		Case "mn-mn": Result = 286
		Case "mr": Result = 268
		Case "mr-mr": Result = 268
		Case "ms": Result = 506
		Case "ms-ms": Result = 506
		Case "mt": Result = 280
		Case "mt-mt": Result = 280
		Case "nb-no": Result = 315
		Case "ne": Result = 306
		Case "ne-ne": Result = 306
		Case "nl": Result = 311
		Case "nl-be": Result = 552
		Case "nl-nl": Result = 311
		Case "nn-no": Result = 314
		Case "no": Result = 313
		Case "no-no": Result = 313
		Case "or": Result = 325
		Case "or-or": Result = 325
		Case "pa": Result = 335
		Case "pa-pa": Result = 335
		Case "pl": Result = 343
		Case "pl-pl": Result = 343
		Case "pt": Result = 345
		Case "pt-br": Result = 508
		Case "pt-pt": Result = 345
		Case "rm": Result = 509
		Case "rm-rm": Result = 509
		Case "ro": Result = 357
		Case "ro-md": Result = 526
		Case "ro-ro": Result = 357
		Case "ru": Result = 359
		Case "ru-md": Result = 527
		Case "ru-ru": Result = 359
		Case "sa": Result = 367
		Case "sa-sa": Result = 367
		Case "sb": Result = 402
		Case "sb-sb": Result = 402
		Case "sk": Result = 383
		Case "sk-sk": Result = 383
		Case "sl": Result = 384
		Case "sl-sl": Result = 384
		Case "sq": Result = 400
		Case "sq-sq": Result = 400
		Case "sr": Result = 529
		Case "sr-sr": Result = 529
		Case "sv": Result = 411
		Case "sv-fi": Result = 528
		Case "sv-sv": Result = 411
		Case "sw": Result = 410
		Case "sw-sw": Result = 410
		Case "sx": Result = 557
		Case "sx-sx": Result = 557
		Case "syr": Result = 412
		Case "ta": Result = 415
		Case "ta-ta": Result = 415
		Case "te": Result = 417
		Case "te-te": Result = 417
		Case "th": Result = 423
		Case "th-th": Result = 423
		Case "tn": Result = 435
		Case "tn-tn": Result = 435
		Case "tr": Result = 440
		Case "tr-tr": Result = 440
		Case "ts": Result = 436
		Case "ts-ts": Result = 436
		Case "tt": Result = 416
		Case "tt-tt": Result = 416
		Case "uk": Result = 447
		Case "uk-uk": Result = 447
		Case "ur": Result = 450
		Case "ur-ur": Result = 450
		Case "uz": Result = 451
		Case "uz-uz": Result = 451
		Case "vi": Result = 454
		Case "vi-vi": Result = 454
		Case "xh": Result = 465
		Case "xh-xh": Result = 465
		Case "yi": Result = 468
		Case "yi-yi": Result = 468
		Case "zh": Result = 80
		Case "zh-cn": Result = 499
		Case "zh-hk": Result = 495
		Case "zh-mo": Result = 496
		Case "zh-sg": Result = 497
		Case "zh-tw": Result = 498
		Case "zh-zh": Result = 80
		Case "zu": Result = 476
		Case "zu-zu": Result = 476
	End Select
