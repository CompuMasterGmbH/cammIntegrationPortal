...
"A sua conta permite o acesso a diversos programas por agora, deverá já ter concluído o processo de associação da nossa Área Protegida. Autorizações adicionais e filiações serão definidas nos próximos 3 - 4 dias. De seguida, por favor, revisite a URL:" & ChrW(13) & ChrW(10) & _
				...
				Logon_Connecting_RecommendationOnTimeout = "Se o problema ocorrer mais uma vez, por favor, contácte-nos."
 ...
 "size=2>.</FONT></P></TD></TR></TABLE>"
		 ...
		 ChrW(13) & ChrW(10) & _
			...
			Case 343:
				...
				Logon_Connecting_RecommendationOnTimeout = "Jeżeli problem pojawi się ponownie, prosimy o kontakt z nami."
...
"[n:1]"
			...
			Case 200:
				...
				Logon_Connecting_RecommendationOnTimeout = "Se questo problema dovesse ripetersi, ci contatti."
...
"[n:2]"
				...
				Logon_Connecting_RecommendationOnTimeout = "Si este problema se produce de nuevo, contáctenos."
		 ...
		 ChrW(13) & ChrW(10) & _
			...
			Case 3:
				...
				Logon_Connecting_RecommendationOnTimeout = "Si ce problème apparaît de nouveau, veuillez nous contacter."
		 ...
		 ChrW(13) & ChrW(10) & _
			...
			Case 2:
				...
				Logon_Connecting_RecommendationOnTimeout = "Sollte dieses Problem wiederholt auftreten, nehmen Sie bitte mit uns Kontakt auf."
		 ...
		 ChrW(13) & ChrW(10) & _
			...
			Case Else:
				...
				Logon_Connecting_RecommendationOnTimeout = "If this problem takes place again, please contact us."
	...
	Public Function CustomLookupOfLanguageID (marketID as Integer) As Integer
		...
		Select Case marketID
			...
			Case 479, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 490, 491, 492, 493, 494, 10003, 10009
				Result = 21
			Case 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 560, 10001, 10015, 10016, 10019, 10021
				Result = 4
			Case 500, 501, 502, 503, 504, 559, 10023
				Result = 3
			Case 510, 511, 512, 513, 558
				Result = 2
			Case 478, 514, 515, 516, 517, 518, 519, 520, 521, 522, 523, 524, 525, 4004, 10000, 10002, 10004, 10005, 10006, 10007, 10008, 10010, 10011, 10012, 10013, 10014, 10017, 10018, 10022
				Result = 1
			Case Else
