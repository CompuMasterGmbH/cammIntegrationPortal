...
<%@ Register TagPrefix="uc1" TagName="control_number_updated_users" Src="control_number_updated_users.ascx" %>
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.UpdatedProfilesOverview" %>
<%@ Register TagPrefix="uc1" TagName="menu" Src="menu.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<camm:webmanager id="cammWebManager" runat="server"></camm:webmanager>
<HTML>
	<HEAD>
		<title>updated_user_profiles_overview</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
			<div align="center">
				<uc1:control_number_updated_users id="NumberUpdatedUsersControl" runat="server"></uc1:control_number_updated_users></div>
