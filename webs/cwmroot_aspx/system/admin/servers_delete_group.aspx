	        ...
	        <TD vAlign=top>
		      <TABLE cellSpacing=0 cellPadding=3 width="100%" border="0" bordercolor="#FFFFFF">
		        <TBODY>
					...
					<ul>
						<li>All currently connected <b>servers</b> will be <b>DELETED</b> permanently.</li>
						<li>The corresponding <b>public user group</b> will be <b>DELETED</b>.</li>
						<li>Relations between access levels and the server group will be DELETED.</li>
