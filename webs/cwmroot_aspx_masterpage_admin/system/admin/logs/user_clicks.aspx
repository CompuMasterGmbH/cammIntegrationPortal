...
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.UserClicks" %>
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
				...
				<asp:table id="printViewTable" runat="server" Visible="False">
					...
					<asp:TableRow>
						<asp:TableCell VerticalAlign="Top" Font-Bold="True" Text="Servergroups:" ID="cellServer"></asp:TableCell>
			...
			<br>
			<div align="center">
				<uc1:control_userbehaviour_clicks id="UserClicksControl" runat="server"></uc1:control_userbehaviour_clicks></div>
