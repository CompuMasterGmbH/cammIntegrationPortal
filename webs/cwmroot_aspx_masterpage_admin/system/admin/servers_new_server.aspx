<%@ Page MasterPageFile="/portal/MasterPage.master" language="VB" Inherits="CompuMaster.camm.WebManager.Pages.Administration.AddNewServer"%>
<%@ Register TagPrefix="camm" TagName="WebManager" Src="~/system/cammWebManager.ascx" %>
<camm:WebManager PageTitle="Administration - Create new server" id="cammWebManager" SecurityObject="System - User Administration - ServerSetup" runat="server" />
...
<%@ Register TagPrefix="camm" TagName="WebManagerAdminBlockContentLine" Src="adminblockcontentline.ascx" %>
		...
		<h3><font face="Arial">Administration - Create new server</font></h3>
		  ...
		  <TR>
	        <TD vAlign="top">
		      <TABLE cellSpacing="0" cellPadding="3" width="100%" border="0" bordercolor="#FFFFFF">
		        <TBODY>
					<TR>
					<TD colspan="2" bgcolor="#C1C1C1"><P><FONT face="Arial" size="2"><b>Initalization details</b></FONT></P></TD>
					</TR>
					<TR>
					<TD VAlign="Top" WIDTH="160"><P><FONT face="Arial" size="2">Server IP / Host Header</FONT></P></TD>
					<TD VAlign="Top" Width="240"><P><FONT face="Arial" size="2">
						
						<asp:Textbox runat="server" id="txtServerIP" />
					</FONT></P></TD>
					</TR>
					
					<TR>
					<TD VAlign="Top" WIDTH="160"><P><FONT face="Arial" size="2">
					<asp:Button Text="Create server" runat="server" id="btnSubmit" />
					</FONT></P></TD>
