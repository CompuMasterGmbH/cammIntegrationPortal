<%@ Page MasterPageFile="/portal/MasterPage.master" language="VB" ValidateRequest="False" Inherits="CompuMaster.camm.WebManager.Pages.Administration.CleanUpUserAuthorization" %>
...
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
		...
		<p style="height:20px"><font face="Arial" size="2" color="red"><asp:label runat="server" id="lblErr" /></font></p>
		...
		<asp:Button runat="server" id="cleanUpBtn" Text="Cleanup all user authorization" />
		<br />
		<hr />
