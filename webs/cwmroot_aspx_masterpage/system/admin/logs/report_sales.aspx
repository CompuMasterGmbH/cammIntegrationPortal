...
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.ReportSales" %>
<%@ Register TagPrefix="camm" TagName="WebManager" Src="~/system/cammWebManager.ascx" %>
<%@ Register TagPrefix="uc1" TagName="control_latest_logon_dates_mod" Src="control_latest_logon_dates_mod.ascx" %>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
				...
				<TABLE id="SelectTable" style="HEIGHT: 71px" width="100%" align="center" runat="server">
					<TR align="center">
						<TD id="cellF" width="30%" height="40">
							<P align="center">
								<asp:label id="LabelFrom" runat="server" font-bold="True" width="45px">From </asp:label>
								<asp:textbox id="TextBoxDateFrom" runat="server" Width="72px"></asp:textbox>
								<asp:label id="LabelDateFromError" runat="server" font-bold="True" width="46px" forecolor="Red"></asp:label></P>
						</TD>
						...
						<TD id="cellT" width="30%" height="40">
							<asp:label id="LabelTo" runat="server" font-bold="True" width="25px">To </asp:label>
							<asp:textbox id="TextBoxDateTo" runat="server" Width="72px"></asp:textbox>
							<asp:label id="LabelDateToError" runat="server" font-bold="True" width="46px" forecolor="Red"></asp:label></TD>
					</TR>
					<TR align="center">
			...
			<br>
			<div align="center">
				<uc1:control_new_users_mod id="NewUsersDetailsControl" runat="server"></uc1:control_new_users_mod></div>
			<br>
			<br>
			<br>
			<div align="center">
			...
			<br>
			<div align="center">
				<uc1:control_latest_logon_dates_mod id="LastLoginDatesControl" runat="server"></uc1:control_latest_logon_dates_mod></div>
