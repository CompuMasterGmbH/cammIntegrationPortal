...
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.CurrentActivity" %>
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<div align="center">
				<TABLE id="SelectTable" cellSpacing="1" cellPadding="1" width="200" border="0" runat="server">
					...
					<TR>
						<TD>
							<asp:Button id="ButtonShowReport" runat="server" Text="Show report" OnClick="Button_Click"></asp:Button></TD>
					</TR>
				</TABLE>
			</div>
			<br>
