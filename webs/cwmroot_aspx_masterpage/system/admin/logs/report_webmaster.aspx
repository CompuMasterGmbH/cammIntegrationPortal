...
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.ReportWebmaster" %>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
			<br>
			<div align="center"><uc1:control_totals id="ApplicationTotalsControl" runat="server"></uc1:control_totals></div>
			<br>
			<br>
			<br>
			...
			<br>
			<div align="center">
				<uc1:eventlog_datagrid id="EventlogDatagridControl" runat="server"></uc1:eventlog_datagrid></div>
			<br>
			<br>
			<br>
			<div align="center">
