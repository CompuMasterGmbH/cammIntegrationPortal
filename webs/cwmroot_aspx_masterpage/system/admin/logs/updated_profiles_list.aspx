...
<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.UpdatedProfilesList" %>
...
<HTML>
	<HEAD>
		<title>updates_user_profiles_list</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
			<div align="center">
				<uc1:control_userbehaviour_updated_user_profiles id="UpdatedProfilesListControl" runat="server"></uc1:control_userbehaviour_updated_user_profiles></div>
