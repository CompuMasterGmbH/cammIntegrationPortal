<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.ApplicationClicks" %>
...
<HTML>
	<HEAD>
		...
		<title>application_clicks</title>
			...
			<asp:linkbutton id="LinkButtonPrintView" onclick="LinkButton_Click" runat="server" CssClass="Link">print view</asp:linkbutton><asp:table id="printViewTable" runat="server" Visible="False">
				...
				<TABLE id="SelectTable" style="HEIGHT: 71px" width="100%" align="center" runat="server">
					<TR align="center">
						...
						<TD id="cellServ" vAlign="bottom" colSpan="3" height="40"><INPUT id="TextBox_hidden" type="hidden" name="TextBox_hidden" runat="server"><STRONG>Server groups:</STRONG></TD>
					...
					<TR>
						<TD vAlign="top" align="center" colSpan="3">
							...
							<P><asp:label id="LabelInterval" runat="server" ForeColor="Red" Font-Bold="True">Label</asp:label></P>
						</TD>
					</TR>
				</TABLE>
			</DIV>
