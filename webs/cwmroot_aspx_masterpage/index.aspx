...
<%@ Register TagPrefix="camm" TagName="PageHtmlBegin" Src="~/portal/includes/standardtemplate_top_nonframeset_serverform_html.ascx" %>
<%@ Register TagPrefix="camm" TagName="PageHtmlEnd" Src="~/portal/includes/standardtemplate_bottom_nonframeset_serverform_html.ascx" %>
<%@ Register TagPrefix="camm" TagName="PageBodyBegin" Src="~/portal/includes/standardtemplate_top_nonframeset_serverform_body.ascx" %>
<%@ Register TagPrefix="camm" TagName="PageBodyEnd" Src="~/portal/includes/standardtemplate_bottom_nonframeset_serverform_body.ascx" %>
