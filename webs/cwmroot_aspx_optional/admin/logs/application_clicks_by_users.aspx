<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.ApplicationClicksByUsers" %>
<%@ Register TagPrefix="uc1" TagName="user_table" Src="user_table.ascx" %>
...
<HTML>
	<HEAD>
		<title>application_click_by_users</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
				...
				<TABLE id="SelectTable" style="HEIGHT: 71px" width="100%" align="center" runat="server">
					...
					<TR>
						<TD vAlign="top" align="center" colSpan="3">
							<P>
								<asp:DropDownList id="UserList" runat="server"></asp:DropDownList></P>
							<P>
			...
			<br>
			<div align="center">
				<uc1:user_table id="UserSelectTable" runat="server"></uc1:user_table></div>
