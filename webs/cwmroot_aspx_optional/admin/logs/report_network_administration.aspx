...
<%@ Page Language="VB" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.ReportNetworkAdministration" %>
...
<HTML>
	<HEAD>
		<title>Network-Administration report</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
			...
			<br>
			<div align="center">
				<uc1:control_totals id="ApplicationTotalsControl" runat="server"></uc1:control_totals></div>
			<br>
			<br>
			<br>
			<div align="center">
