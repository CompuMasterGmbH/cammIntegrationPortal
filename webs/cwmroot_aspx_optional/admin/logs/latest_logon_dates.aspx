<%@ Page Language="vb" Inherits="CompuMaster.camm.WebManager.Modules.LogAnalysis.Pages.LatestLogonDates" %>
<%@ Register TagPrefix="uc1" TagName="latest_logon" Src="control_userbehaviour_latest_logon_dates.ascx" %>
...
<HTML>
	<HEAD>
		<title>latest_logon_dates</title>
...
<form id="Form1" method="post" runat="server">
	<asp:Table Runat="server" ID="BorderTable" BackColor="#F7F7F7" CellPadding="0" CellSpacing="0" BorderColor="#C0C0C0" BorderWidth="0" Height="100%" Width="100%">
		...
		<asp:TableRow Runat="server" ID="LeftRightBorderTRow">
				...
				<TABLE id="SelectTable" style="HEIGHT: 71px" width="100%" align="center" runat="server">
					...
					<TR>
						<TD vAlign="top" align="center" colSpan="3">
							<P>
								<asp:DropDownList id="ModeList" runat="server"></asp:DropDownList></P>
							<P>
			...
			<br>
			<div align="center">
				<uc1:latest_logon id="LatestLogonDatesControl" runat="server"></uc1:latest_logon></div>
