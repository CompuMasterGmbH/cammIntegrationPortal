...
Namespace Customization.Navigation
    ...
    <CLSCompliantAttribute(False)> Public Class ASPNetMenu
        ...
        Private Sub FillSubElements(ByVal NavigationData As DataTable, ByVal BaseLevel As String, ByVal MenuGroup As CYBERAKT.WebControls.Navigation.MenuGroup)
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                If CurCategory <> "" Then 'AndAlso Not Navigation.ValueAlreadyExistsInDataTable(MySubElements, "Title", CurCategory) Then
                    ...
                    MyMenuItem.ID = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("ID"))
                    MyMenuItem.URL = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("URLAutoCompleted")))
                    MyMenuItem.URLAbsolute = True
                    MyMenuItem.URLTarget = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("Target")))
                    MyMenuItem.Alt = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("Tooltip")))
                    If CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("IsDisabledInStandardSituations"), False) = True Then
                    ...
                    MyMenuItem.LeftIcon = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("LeftIconSrc")))
                    MyMenuItem.LeftIconOver = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("LeftIconSrcOver")))
                    MyMenuItem.LeftIconDown = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("LeftIconSrcDown")))
                    MyMenuItem.LeftIconWidth = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("LeftIconWidth")))
                    MyMenuItem.LeftIconHeight = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("LeftIconHeight")))
                    MyMenuItem.RightIcon = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("RightIconSrc")))
                    MyMenuItem.RightIconOver = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("RightIconSrcOver")))
                    MyMenuItem.RightIconDown = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("RightIconSrcDown")))
                    MyMenuItem.RightIconWidth = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("RightIconWidth")))
                    MyMenuItem.RightIconHeight = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("RightIconHeight")))
                    MyMenuItem.NoWrap = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("NoWrap"), False)
                    MyMenuItem.CssClass = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClass")))
                    MyMenuItem.CssClassOver = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClassOver")))
                    MyMenuItem.CssClassDown = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClassDown")))
                    MyMenuItem.ClientSideOnClick = CompuMaster.camm.WebManager.Utils.StringNotEmptyOrNothing(CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("ClientSideOnClick")))
                End If
        ...
        Public Function CreateNavigationItem(ByVal NavMenuGroup As CYBERAKT.WebControls.Navigation.MenuGroup, ByVal TitlePath As String, ByVal IsCurrentlySelectedPath As Boolean) As CYBERAKT.WebControls.Navigation.MenuItem
            ...
            For Each CurCategory In TitlePath.Split("\")
        ...
        Private Sub ApplyDefaults(ByVal NavMenuItem As CYBERAKT.WebControls.Navigation.MenuItem, ByVal DefaultValues As Collections.Specialized.NameValueCollection)
            For Each MyKey As String In DefaultValues.AllKeys
                Select Case MyKey.ToLower(System.Globalization.CultureInfo.InvariantCulture)
                    ...
                    Case "lefticonsrc"
                        NavMenuItem.LeftIconHeight = CType(_DefaultOverridesForGroups(MyKey), String)
                    ...
                    Case "righticonsrc"
                        NavMenuItem.RightIconHeight = CType(_DefaultOverridesForGroups(MyKey), String)
        ...
        Private Sub FillSubElements(ByVal NavigationData As DataTable, ByVal BaseLevel As String, ByVal MenuGroup As ComponentArt.Web.UI.MenuItemCollection)
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                If CurCategory <> "" Then 'AndAlso Not Navigation.ValueAlreadyExistsInDataTable(MySubElements, "Title", CurCategory) Then
                    ...
                    'Fill menu item detail info
                    MyMenuItem.ID = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("ID"))
                    MyMenuItem.NavigateUrl = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("URLAutoCompleted"))
                    MyMenuItem.Target = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("Target"))
                    MyMenuItem.ToolTip = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("Tooltip"))
                    If CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("IsDisabledInStandardSituations"), False) = True Then
                    ...
                    MyMenuItem.CssClass = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClass"))
                    ...
                    MyMenuItem.ClientSideCommand = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("ClientSideOnClick"))
                End If
        ...
        Private Sub FillSubElements(ByVal NavigationData As DataTable, ByVal BaseLevel As String, ByVal MenuGroup As ComponentArt.Web.UI.TreeViewNodeCollection)
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                If CurCategory <> "" Then 'AndAlso Not Navigation.ValueAlreadyExistsInDataTable(MySubElements, "Title", CurCategory) Then
                    ...
                    'MyMenuItem.TextWrap = Not Nz(MyRows(MyCounter)("NoWrap"), False)
                    MyMenuItem.CssClass = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClass"))
                    MyMenuItem.HoverCssClass = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClassOver"))
                    MyMenuItem.SelectedCssClass = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("CssClassDown"))
                    MyMenuItem.ClientSideCommand = CompuMaster.camm.WebManager.Utils.Nz(MyRows(MyCounter)("ClientSideOnClick"))
                End If
    ...
    Public Module Utils
        ...
        Private Sub VerifyDataAndFillMissingElementsAddMissingHierarchyLevels(ByVal navData As DataTable, ByVal columnIndexTitle As Integer)
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                Dim MyCurrentTitleSubParts As String() = MyCurrentTitle.Split("\")
        ...
        Private Sub VerifyDataAndFillMissingElementsRemoveDuplicates(ByVal navData As DataTable, ByVal columnIndexTitle As Integer)
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                Else
                    MyPreviousTitle = MyPreviousRow(columnIndexTitle)
                End If
                If IsDBNull(MyCurrentRow(columnIndexTitle)) Then
                    MyCurrentTitle = Nothing
                Else
                    MyCurrentTitle = MyCurrentRow(columnIndexTitle)
                End If
        ...
        Public Function IsCategoryInListOfCategories(ByVal searchForCategory As String, ByVal listOfCategories As String, ByVal searchWithinSubelements As Boolean) As Boolean
            ...
            If searchWithinSubelements = True AndAlso searchForCategory = "\" Then
                ...
                Return True
            End If
            For Each CurCategory In listOfCategories.Split(";")
                CurCategory = Trim(CurCategory)
                If CurCategory = "" Then
                    CurCategory = "\"
                End If
        ...
        Public Function CategoryPathElements(ByVal CategoryPath As String) As SortedList
            ...
            Dim CurCategory As String
            For Each CurCategory In CategoryPath.Split("\")
                CurCategory = Trim(CurCategory)
                If CurCategory <> "" Then
        ...
        Public Function SubCategories(ByVal NavData As DataTable, ByVal CurrentBaseLevel As String) As DataTable
            ...
            For MyCounter As Integer = 0 To MyRows.Length - 1
                ...
                Else
                    ...
                    End If
                End If
                If NextCategoryLevelName <> "\" AndAlso NextCategoryLevelTitle <> "" AndAlso MyRows(MyCounter)("Title") = NextCategoryLevelName Then
                    'Copy data row
