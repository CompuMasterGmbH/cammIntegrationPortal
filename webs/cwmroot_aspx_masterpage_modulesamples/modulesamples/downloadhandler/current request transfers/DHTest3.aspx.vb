    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If cammWebManager.DownloadHandler.IsFullyFeatured Then
            ...
            If cammWebManager.DownloadHandler.DownloadFileAlreadyExists(cammWebManager.DownloadHandler.DownloadLocations.WebManagerUserSession, "images", "style_images.zip") Then
                Response.Redirect(cammWebManager.DownloadHandler.CreateDownloadLink(cammWebManager.DownloadHandler.DownloadLocations.WebManagerUserSession, "images", "style_images.zip"))
            Else
                ...
                cammWebManager.DownloadHandler.ProcessDownload(cammWebManager.DownloadHandler.DownloadLocations.WebManagerUserSession, "images", True, Nothing, True, "style_images.zip")
            End If
        Else
