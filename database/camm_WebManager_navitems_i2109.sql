...
IF @OldAppID_Logs IS NOT NULL 
	BEGIN
	UPDATE dbo.ApplicationsRightsByGroup SET ID_Application = @AppID_Logs WHERE ID_Application = @OldAppID_Logs AND [IsSupervisorAutoAccessRule] = 0 AND ID_GroupOrPerson NOT IN (7) -- these ones have already been addded
...
-----------------------------------------------------------------------
-- BULK INSERT NAV ITEMS FOR ADDITONAL LANGUAGES FOR PERFORMANCE
-----------------------------------------------------------------------

-- PREPARE INHERITING ITEMS FOR ADDITIONAL LANGUAGES
DECLARE @NewApplications table(
	...
	[NavTooltipText] [nvarchar](1024) NULL,
	[IsNew] [bit] NOT NULL DEFAULT (0),
	[IsUpdated] [bit] NOT NULL DEFAULT (0),
	[LocationID] [int] NOT NULL,
	[LanguageID] [int] NOT NULL,
	[SystemApp] [bit] NOT NULL DEFAULT (0),
	[ModifiedOn] [datetime] NULL DEFAULT (getdate()),
	[ModifiedBy] [int] NULL,
	[AppDisabled] [bit] NOT NULL DEFAULT (1),
	[AuthsAsAppID] [int] NULL,
	[Sort] [int] NULL DEFAULT (1000000),
	[ResetIsNewUpdatedStatusOn] [datetime] NULL,
	[AppDeleted] [bit] NOT NULL DEFAULT (0),
	[OnMouseOver] [nvarchar](512) NULL,
	[OnMouseOut] [nvarchar](512) NULL,
	[OnClick] [nvarchar](512) NULL,
	[AddLanguageID2URL] [bit] NOT NULL DEFAULT (1),
	[Level1TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[Level2TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[Level3TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[Level4TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[Level5TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[Level6TitleIsHTMLCoded] [bit] NOT NULL DEFAULT (0),
	[SystemAppType] [int] NULL
/*
	,
	[Remarks] [nvarchar](512) NULL,
	[RequiredUserProfileFlags] [nvarchar](4000) NULL,
...
INSERT INTO @NewApplications (Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,SystemAppType) 
...
INSERT INTO @NewApplications (Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,SystemAppType) 
VALUES('System - User Administration - LogAnalysis',NULL,getdate(),@ModifiedBy,N'Web-Administration',N'Log Auswertungen',N'Web-Manager',NULL,NULL,NULL,'[ADMINURL]logs/index.aspx',NULL,NULL,0,0,@NewServerID,N'2',1,getdate(),@ModifiedBy,0,@AppID_Logs,1000000,NULL,0,NULL,NULL,NULL,1,2)

INSERT INTO @NewApplications (Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,SystemAppType) 
VALUES('System - User Administration - Users',NULL,getdate(),@ModifiedBy,N'Web-Administration',N'Trouble Center',N'Benutzer Hotline Support',NULL,NULL,NULL,'[ADMINURL]users_hotline_support.aspx',NULL,NULL,0,0,@NewServerID,N'2',1,getdate(),@ModifiedBy,0,@AppID_Users,1000000,NULL,0,NULL,NULL,NULL,1,2)
INSERT INTO @NewApplications (Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,SystemAppType) 
...
INSERT INTO @NewApplications (Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,SystemAppType) 
VALUES('System - User Administration - LogAnalysis',NULL,getdate(),@ModifiedBy,N'Administracja Web',N'Analizy logowań',N'Web-Manager',NULL,NULL,NULL,'[ADMINURL]logs/index.aspx',NULL,NULL,0,0,@NewServerID,N'343',1,getdate(),@ModifiedBy,0,@AppID_Logs ,1000000,NULL,0,NULL,NULL,NULL,1,2)
...
-- FINALLY BULK-INSERT PREPARED ITEMS
INSERT INTO dbo.Applications_CurrentAndInactiveOnes (
	   Title,TitleAdminArea,ReleasedOn,ReleasedBy,Level1Title,Level2Title,Level3Title,Level4Title,Level5Title,Level6Title,NavURL,NavFrame,NavTooltipText,IsNew,IsUpdated,LocationID,LanguageID,SystemApp,ModifiedOn,ModifiedBy,AppDisabled,AuthsAsAppID,Sort,ResetIsNewUpdatedStatusOn,AppDeleted,OnMouseOver,OnMouseOut,OnClick,AddLanguageID2URL,[Level1TitleIsHTMLCoded],[Level2TitleIsHTMLCoded],[Level3TitleIsHTMLCoded],[Level4TitleIsHTMLCoded],[Level5TitleIsHTMLCoded],[Level6TitleIsHTMLCoded],SystemAppType) 
SELECT [Title],[TitleAdminArea],[ReleasedOn],[ReleasedBy],[Level1Title],[Level2Title],[Level3Title],[Level4Title],[Level5Title],[Level6Title],[NavURL],[NavFrame],[NavTooltipText],[IsNew],[IsUpdated],[LocationID],[LanguageID],[SystemApp],[ModifiedOn],[ModifiedBy],[AppDisabled],[AuthsAsAppID],[Sort],[ResetIsNewUpdatedStatusOn],[AppDeleted],[OnMouseOver],[OnMouseOut],[OnClick],[AddLanguageID2URL],[Level1TitleIsHTMLCoded],[Level2TitleIsHTMLCoded],[Level3TitleIsHTMLCoded],[Level4TitleIsHTMLCoded],[Level5TitleIsHTMLCoded],[Level6TitleIsHTMLCoded],[SystemAppType]
