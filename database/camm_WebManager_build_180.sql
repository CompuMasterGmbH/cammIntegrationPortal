...
CREATE  INDEX [IX_NavItems] ON [dbo].[NavItems]([ID], [LanguageID]) WITH  FILLFACTOR = 90 ON [PRIMARY]
CREATE  INDEX [IX_NavItems_1] ON [dbo].[NavItems]([ID], [ServerID]) WITH  FILLFACTOR = 90 ON [PRIMARY]
CREATE  INDEX [IX_SecurityObjects_vs_NavItems] ON [dbo].[SecurityObjects_vs_NavItems]([ID_SecurityObject]) WITH  FILLFACTOR = 90 ON [PRIMARY]
CREATE  INDEX [IX_SecurityObjects_vs_NavItems_1] ON [dbo].[SecurityObjects_vs_NavItems]([ID_NavItem]) WITH  FILLFACTOR = 90 ON [PRIMARY]
CREATE  INDEX [IX_SecurityObjects_1] ON [dbo].[SecurityObjects_CurrentAndInactiveOnes]([AuthsAsSecObjID]) WITH  FILLFACTOR = 90 ON [PRIMARY]
